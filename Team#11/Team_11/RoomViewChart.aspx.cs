...
namespace Team_11
{
    public partial class RoomViewChart : System.Web.UI.Page
    {
        ...
        private void GetChartData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand(" Select RoomView, count(*) as 'Numbers' from Rooms GROUP BY RoomView ORDER BY COUNT(*) DESC ; ", con);
                ...
                while (rdr.Read())
                {
                    ...
                    series.Points.AddXY(rdr["RoomView"].ToString(), rdr["Numbers"]);
                }
            }
        }
