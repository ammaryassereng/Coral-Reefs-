...
namespace Team_11
{
    public partial class RoomsChart : System.Web.UI.Page
    {
        ...
        private void GetChartData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand(" SELECT RoomNumber,count(*) as 'Number of Occurences' FROM Occupied GROUP BY RoomNumber ORDER BY COUNT(*) DESC ", con);
                ...
                while (rdr.Read())
                {
                    ...
                    series.Points.AddXY(rdr["RoomNumber"].ToString(), rdr["Number of Occurences"]);
                }
            }
        }
