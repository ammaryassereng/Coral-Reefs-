...
namespace Team_11
{
    public partial class SpecOccChart : System.Web.UI.Page
    {
        ...
        private void GetChartData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand(" 	SELECT Type, count(*) as 'Number of Occurences'    FROM     SpecialOccasions    GROUP BY Type    ORDER BY COUNT(*) DESC  ; ", con);
                ...
                while (rdr.Read())
                {
                    ...
                    series.Points.AddXY(rdr["Type"].ToString(), rdr["Number of Occurences"]);
                }
            }
        }
