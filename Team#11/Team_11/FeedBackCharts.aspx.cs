...
namespace Team_11
{
    public partial class FeedBackCharts : System.Web.UI.Page
    {
        ...
        private void GetChartData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand(" SELECT FeedBack,count(*) as 'Number of Occurences'    FROM FeedBack     GROUP BY Feedback    ORDER BY COUNT(*) DESC ; ", con);
                ...
                while (rdr.Read())
                {
                    ...
                    series.Points.AddXY(rdr["FeedBack"].ToString(), rdr["Number of Occurences"]);
                }
            }
        }
