<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="FeedBackCharts.aspx.cs" Inherits="Team_11.FeedBackCharts" %>
    ...
    <section style="overflow: auto; height: 500px; margin-bottom: 200px; margin-top:100px;">
     ...
     <div class="container py-4">  
            ...
            <asp:Chart ID="Chart1" runat="server" Width="450" OnLoad="Chart1_Load">  
                <Titles>  
                    <asp:Title Text="FeedBack Chart"></asp:Title>  
                </Titles>  
                <Series>  
