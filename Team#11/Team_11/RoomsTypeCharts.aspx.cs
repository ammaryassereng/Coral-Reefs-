...
namespace Team_11
{
    public partial class RoomsTypeCharts : System.Web.UI.Page
    {
        ...
        private void GetChartData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand(" Select Type, count(*) as 'Numbers' from Rooms GROUP BY Type ORDER BY COUNT(*) DESC ; ", con);
                ...
                while (rdr.Read())
                {
                    ...
                    series.Points.AddXY(rdr["Type"].ToString(), rdr["Numbers"]);
                }
            }
        }
