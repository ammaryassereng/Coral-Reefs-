<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="RoomsStateChart.aspx.cs" Inherits="Team_11.RoomsStateChart" %>
    ...
    <section style="overflow: auto; height: 500px; margin-bottom: 200px; margin-top:100px;">
     ...
     <div class="container py-4">  
            ...
            <asp:Chart ID="Chart1" runat="server" Width="450" OnLoad="Chart1_Load">  
                <Titles>  
                    <asp:Title Text="Rooms State Chart"></asp:Title>  
                </Titles>  
                <Series>  
                ...
                <ChartAreas>  
                    <asp:ChartArea Name="ChartArea1">  
                        <AxisX Title="State"></AxisX>  
                        <AxisY Title="Numbers"></AxisY>  
                    </asp:ChartArea>  
                </ChartAreas>  
            </asp:Chart>  
        </div>
